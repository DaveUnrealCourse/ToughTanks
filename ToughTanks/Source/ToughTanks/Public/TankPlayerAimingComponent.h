...
#include "TankPlayerAimingComponent.generated.h"

//Enum for Aiming state
UENUM()
enum class EPlayerFiringState : uint8
{
	Reloading,
	Aiming,
	Locked,
...
class TOUGHTANKS_API UTankPlayerAimingComponent : public UActorComponent
{
	GENERATED_BODY()
public:
	void BeginPlay();
	...
	EPlayerFiringState GetFiringState() const;

protected:
	UPROPERTY(BlueprintReadOnly, Category = "State")
		EPlayerFiringState FiringState = EPlayerFiringState::Reloading;
private:
	UTankPlayerAimingComponent();
